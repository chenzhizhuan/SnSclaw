export default {
  ...
  settings: {
    ...
    hints: {
      ...
      workspaceStorageRootPlaceholder: 'Leave blank for the server default, e.g. /data/snsclaw/workspace',
  ...
  agents: {
    ...
    fields: {
      ...
      runtimeNativeHint: 'Uses SnSclaw\'s native Agent Loop.',
  ...
  plugins: {
    ...
    emptyHint: 'Place plugin JAR files in ~/.snsclaw/plugins/ and restart the server',
  ...
  talk: {
    ...
    holdSpaceHint: 'Or hold Space to talk, release to send',
    holdingSpace: 'Recording — release Space to send',
    retry: 'Tap to retry',
    you: 'You',
    ai: 'AI',
