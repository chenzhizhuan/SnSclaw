...
[![GitHub 仓库](https://img.shields.io/badge/GitHub-仓库-black.svg?logo=github)](https://github.com/sns/SnSclaw)
...
[![最后提交](https://img.shields.io/github/last-commit/mateaix/mateclaw)](https://github.com/sns/SnSclaw)
...
从 [GitHub Releases](https://github.com/sns/SnSclaw/releases) 下载安装包。内嵌 JRE 21，无需额外装 Java。
...
桌面端安装包通过 [GitHub Releases](https://github.com/sns/SnSclaw/releases) 分发，内嵌 JRE 21——无需安装 Java。
