...
去 [GitHub Releases](https://github.com/sns/SnSclaw/releases) 拿最新安装包。
...
- **还是不行**——去 [GitHub Issues](https://github.com/sns/SnSclaw/issues) 开一个 Issue，把 `app.log` 的尾巴贴上。我们真的会看。
