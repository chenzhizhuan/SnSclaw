...
常见问题 + 真答案。你的问题不在这里就看对应的功能页，或者去 [GitHub issue](https://github.com/sns/SnSclaw/issues) 开一个。
...
**自动更新**通过 electron-updater。启动时检查 GitHub Releases 并弹提示。也可以手动从 [Releases](https://github.com/sns/SnSclaw/releases) 下载。
...
- [GitHub Issues](https://github.com/sns/SnSclaw/issues)——文档没答案的时候去这里
