...
hero:
  ...
  tagline: Other personal AI agents are built for one person. SnSclaw is built for a team — multi-user workspaces, approval-gated sensitive actions, full audit trail, production-grade health monitoring. One self-hosted JAR; you control persisted data and outbound integration boundaries.
  image:
    src: /logo.png
    alt: SnSclaw
  actions:
