...
Grab the latest installer from [GitHub Releases](https://lab.sns.app/SnSclaw/releases).
...
- **Still broken** — Open an issue on [GitHub](https://lab.sns.app/SnSclaw/issues) with the tail of `app.log`. We read them.
