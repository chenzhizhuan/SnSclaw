...
Grab the latest installer from [GitHub Releases](https://github.com/sns/SnSclaw/releases).

- **Windows** — `SnSclaw-Setup-x.y.z.exe`
- **macOS** — `SnSclaw-x.y.z.dmg`
- **Linux** — `SnSclaw-x.y.z.AppImage`
...
- **Ollama** — local GPU users; SnSclaw auto-detects `localhost:11434`
...
- **Still broken** — Open an issue on [GitHub](https://github.com/sns/SnSclaw/issues) with the tail of `app.log`. We read them.
